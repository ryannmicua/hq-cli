...
| P0 | Contracts and read CLI phase | not-started | Plan: `docs/superpowers/plans/2026-07-24-phase-0-contracts-and-reads.md` | Start only after document approval |
| P1 | Submit and status phase | not-started | Plan: `docs/superpowers/plans/2026-07-24-phase-1-submit-and-status.md` | Requires verified P0 |
| P2 | Apply, recovery, and changes phase | not-started | Plan: `docs/superpowers/plans/2026-07-24-phase-2-apply-and-changes.md` | Requires verified P1 |
| P3 | Skill and release phase | not-started | Plan: `docs/superpowers/plans/2026-07-24-phase-3-skill-and-release.md` | Requires verified P2 |
